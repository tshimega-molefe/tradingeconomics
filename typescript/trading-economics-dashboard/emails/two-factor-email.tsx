...
export const TwoFactorEmail = ({ token }: TwoFactorEmailProps) => (
  <Html>
    <Head />
    <Preview>{`2FA Code: ${token}`}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={secondary}>
          Enter the following code to finish linking Trading Economics.
        </Heading>
        ...
        <Text style={paragraph}>
          Contact{" "}
          <Link href="mailto:tshimega.mol@gmail.com" style={link}>
            login@haul.com
          </Link>{" "}
          if you did not request this code.
        </Text>
      </Container>
      <Text style={footer}>Securely powered by Trading Economics.</Text>
    </Body>
  </Html>
);
